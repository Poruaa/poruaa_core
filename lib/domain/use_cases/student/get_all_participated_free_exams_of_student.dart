...
class GetAllParticipatedFreeExamsOfStudent {
  final FreeExamRepository _freeExamRepository;

  GetAllParticipatedFreeExamsOfStudent(this._freeExamRepository);

  Future<Result<List<FreeExam>>> execute() async {
    return await _freeExamRepository.getAllParticipatedFreeExamsOfStudentByMe();
  }
}
